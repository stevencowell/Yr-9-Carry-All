window.LESSON_CONFIG = {
  "storageKey": "carry-all-weeks5-6-guided-v1",
  "resetLabel": "Weeks 5-6",
  "title": "Carry-All Weeks 5-6"
};
window.MC_QUESTIONS = [
  {
  ...
  },
  {
    ...
    "strongHint": "The warning sign is: A weak approach is forcing a tight joint together or relying on adhesive to fill inaccurate gaps.",
    "feedback": [
      "Recording a check supports quality.",
      "Using the approved source supports safe and accurate work.",
      "Correct. A weak approach is forcing a tight joint together or relying on adhesive to fill inaccurate gaps.",
  ...
  },
  {
    ...
    "correct": 2,
    "hint": "Look for the option that describes a specific Carry-All fault or weak process.",
    "strongHint": "The warning sign is: A weak approach is measuring the matching joint separately or forcing together tails and pins that do not fit.",
    "feedback": [
      "Recording a check supports quality.",
      "Using the approved source supports safe and accurate work.",
      "Correct. A weak approach is measuring the matching joint separately or forcing together tails and pins that do not fit.",
      "Comparison with the brief is a sound quality step."
    ]
  },
  {
