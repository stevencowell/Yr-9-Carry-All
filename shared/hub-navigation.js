(function () {
  ...
  nav.setAttribute("aria-label", "Carry-All course navigation");
  ...
  brand.innerHTML = '<span class="course-family-nav__mark" aria-hidden="true">CA</span><span>Carry-All</span>';
